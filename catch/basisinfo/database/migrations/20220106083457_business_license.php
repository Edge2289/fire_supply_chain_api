...
class BusinessLicense extends Migrator
{
    public function change()
    {
        ...
        $table->addColumn('company_name', 'string', ['limit' => 300, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '企业名称',])
            ...
            ->addColumn('data_maintenance', 'integer', ['limit' => MysqlAdapter::INT_TINY, 'null' => false, 'default' => '', 'signed' => false, 'comment' => '资料维护 1 经营许可证 2 经营备案凭证',])
            ...
            ->addColumn('status', 'integer', ['limit' => MysqlAdapter::INT_TINY, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '是否使用 {0:禁用,1:启动}',])
