...
class BusinessAttachment extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('business_license_url', 'string', ['limit' => 1000, 'default' => '', 'signed' => true, 'comment' => '营业执照url',])
            ->addColumn('check_business_license', 'integer', ['limit' => MysqlAdapter::INT_TINY, 'default' => 0, 'signed' => true, 'comment' => '核对营业执照',])
            ->addColumn('production_license_url', 'string', ['limit' => 1000, 'default' => "", 'signed' => true, 'comment' => '医疗器械经营许可证url',])
            ->addColumn('check_production_license', 'integer', ['limit' => MysqlAdapter::INT_TINY, 'default' => 0, 'signed' => true, 'comment' => '核对医疗器械经营许可证',])
            ->addColumn('record_certificate_url', 'string', ['limit' => 1000, 'default' => "", 'signed' => true, 'comment' => '第二类医疗器械经营备案凭证/生产备案凭证url',])
