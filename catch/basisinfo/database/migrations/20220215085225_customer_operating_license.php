...
class CustomerOperatingLicense extends Migrator
{
    public function change()
    {
        $table = $this->table('customer_operating_license', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '经营许可证', 'id' => 'id', 'signed' => true, 'primary_key' => ['id']]);
