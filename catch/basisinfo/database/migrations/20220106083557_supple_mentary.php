...
class SuppleMentary extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('business_license_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '营业执照id',])
            ...
            ->addColumn('phone', 'string', ['limit' => 100, 'null' => false, 'default' => "", 'signed' => true, 'comment' => '手机号',])
            ->addColumn('email', 'string', ['limit' => 100, 'null' => false, 'default' => '1', 'signed' => false, 'comment' => '邮箱',])
            ...
            ->addColumn('license_area', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'default' => 0, 'signed' => true, 'comment' => '授权区域',])
            ->addColumn('product_line', 'string', ['limit' => 1000, 'default' => '', 'signed' => false, 'comment' => '产品线',])
            ->addColumn('other', 'string', ['limit' => 1000, 'default' => '', 'signed' => false, 'comment' => '备注',])
            // 付款信息
            ->addColumn('invoice_head', 'string', ['limit' => 1000, 'null' => false, 'default' => '', 'signed' => false, 'comment' => '发票抬头',])
            ->addColumn('invoice_no', 'string', ['limit' => 1000, 'null' => false, 'default' => '', 'signed' => false, 'comment' => '税号',])
            ->addColumn('invoice_bank', 'string', ['limit' => 1000, 'null' => false, 'default' => '', 'signed' => false, 'comment' => '开户银行',])
            ->addColumn('invoice_bank_no', 'string', ['limit' => 1000, 'null' => false, 'default' => '', 'signed' => false, 'comment' => '银行账号',])
            ->addColumn('company_address', 'string', ['limit' => 1000, 'default' => '', 'signed' => false, 'comment' => '企业地址',])
            ->addColumn('company_phone', 'string', ['limit' => 1000, 'default' => '', 'signed' => false, 'comment' => '企业电话',])
