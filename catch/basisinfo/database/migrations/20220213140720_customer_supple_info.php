...
class CustomerSuppleInfo extends Migrator
{
    public function change()
    {
        $table = $this->table('customer_supple_info', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '补充信息', 'id' => 'id', 'signed' => true, 'primary_key' => ['id']]);
