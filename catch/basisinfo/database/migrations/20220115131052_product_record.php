...
class ProductRecord extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('product_id', 'integer', ['limit' => MysqlAdapter::INT_MEDIUM, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '厂家id',])
            ...
            ->addColumn('recorder_org_code', 'string', ['limit' => 300, 'default' => '', 'null' => false, 'signed' => true, 'comment' => '备案人组织机构代码',])
            ...
            ->addColumn('product_desc', 'string', ['limit' => 300, 'default' => '', 'signed' => true, 'comment' => '预备用途',])
            ->addColumn('record_department', 'string', ['limit' => 300, 'default' => '', 'signed' => true, 'comment' => '备案单位',])
            ->addColumn('record_time', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'default' => 0, 'signed' => true, 'comment' => '备案日期',])
