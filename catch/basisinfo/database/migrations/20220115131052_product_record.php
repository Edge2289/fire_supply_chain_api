...
class ProductRecord extends Migrator
{
    ...
    {
        $table = $this->table('product_record', ['engine' => 'Myisam', 'collation' => 'utf8mb4_general_ci', 'comment' => '厂家生产许可证', 'id' => 'id', 'signed' => true, 'primary_key' => ['id']]);
        $table->addColumn('product_id', 'integer', ['limit' => MysqlAdapter::INT_MEDIUM, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '厂家id',])
            ->addColumn('record_license_url', 'string', ['limit' => 200, 'null' => false, 'default' => "", 'signed' => true, 'comment' => '备案凭证照片',])
            ->addColumn('record_product_categories', 'integer', ['limit' => MysqlAdapter::INT_MEDIUM, 'null' => false, 'default' => '', 'signed' => false, 'comment' => '产品分类',])
            ->addColumn('record_code', 'string', ['limit' => 100, 'null' => false, 'default' => '', 'signed' => false, 'comment' => '备案号',])
            ->addColumn('recorder_org_code', 'string', ['limit' => 300, 'default' => 0, 'null' => false, 'signed' => true, 'comment' => '备案人组织机构代码',])
            ->addColumn('record_name', 'string', ['limit' => 60, 'default' => '', 'null' => false, 'signed' => false, 'comment' => '备案人名称',])
            ->addColumn('record_creator_company_address', 'string', ['limit' => 300, 'default' => '', 'null' => false, 'signed' => false, 'comment' => '备案人生产地址',])
            ->addColumn('record_proxy_name', 'string', ['limit' => 100, 'default' => '', 'null' => false, 'signed' => false, 'comment' => '代理人',])
            ->addColumn('record_proxy_address', 'string', ['limit' => 300, 'default' => '', 'null' => false, 'signed' => false, 'comment' => '代理人注册住址',])
            ...
            ->addColumn('record_time', 'string', ['limit' => 300, 'default' => '', 'signed' => true, 'comment' => '备案日期',])
