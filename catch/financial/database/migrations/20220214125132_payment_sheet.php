...
class PaymentSheet extends Migrator
{
    public function change()
    {
        $table = $this->table('payment_sheet', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '付款单', 'id' => 'id', 'signed' => true, 'primary_key' => ['id']]);
        $table->addColumn('supplier_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '客户id',])
            ->addColumn('payment_code', 'string', ['limit' => 30, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '付款单号',])
