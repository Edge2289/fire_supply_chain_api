...
class ReadyOutboundDetails extends Migrator
{
    public function change()
    {
        $table = $this->table('ready_outbound_details', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '寄售出库明细', 'id' => 'id', 'signed' => true, 'primary_key' => ['id']]);
        $table->addColumn('ready_outbound_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'default' => 0, 'signed' => true, 'comment' => '寄售出库id',])
            ...
            ->addColumn('resold_quantity', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'null' => false, 'default' => 0, 'signed' => false, 'comment' => '入库数',])
            ->addColumn('inventory_quantity', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'null' => false, 'default' => 0, 'signed' => false, 'comment' => '转销售数',])
