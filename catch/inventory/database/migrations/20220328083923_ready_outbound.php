...
class ReadyOutbound extends Migrator
{
    ...
    {
        $table = $this->table('ready_outbound', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '备货出库', 'id' => 'id', 'signed' => true, 'primary_key' => ['id']]);
        $table->addColumn('ready_outbound_code', 'string', ['limit' => 60, 'default' => 0, 'signed' => true, 'comment' => '备货出库编号',])
            ...
            ->addColumn('resold_quantity', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '转销售数量',])
            ->addColumn('inventory_quantity', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'null' => false, 'default' => 0, 'signed' => true, 'comment' => '入库数量',])
