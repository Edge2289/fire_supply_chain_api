...
class ConsignmentOutboundDetails extends Migrator
{
    public function change()
    {
        $table = $this->table('consignment_outbound_details', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '寄售出库明细', 'id' => 'id', 'signed' => true, 'primary_key' => ['id']]);
        $table->addColumn('consignment_outbound_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'default' => 0, 'signed' => true, 'comment' => '销售订单id',])
