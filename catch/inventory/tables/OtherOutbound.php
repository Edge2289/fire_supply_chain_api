 ...
 */
class OtherOutbound extends CatchTable
{
    protected function table()
    {
        return $this->getTable('otherOutbound')
            ->header([
                HeaderItem::label()->selection(),
                HeaderItem::label('状态')->width(80)->prop('status_i'),
                HeaderItem::label('编号')->width(130)->prop('other_outbound_code'),
